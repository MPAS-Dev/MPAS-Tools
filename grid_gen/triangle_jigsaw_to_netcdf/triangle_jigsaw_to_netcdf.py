#!/usr/bin/env python
"""
Script to convert Triangle and JIGSAW output into a netCDF file for use with the MPASMeshConverter.x
to produce a valid MPAS mesh.

Phillip J. Wolfram and Matthew Hoffman
...
parser.add_option("-m", "--msh", dest="msh", help="input .msh file generated by JIGSAW.", metavar="FILE")
