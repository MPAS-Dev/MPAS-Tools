...
if __name__ == "__main__":
    ...
    parser.add_argument("-n", "--node", dest="node", help="input .node file generated by Triangle.", metavar="FILE")
    parser.add_argument("-e", "--ele", dest="ele", help="input .ele file generated by Triangle.", metavar="FILE")
    parser.add_argument("-m", "--msh", dest="msh", help="input .msh file generated by JIGSAW.", metavar="FILE")
    ...
    if options.msh:
        ...
        assert cellsOnVertex_full.shape == (nVertices, vertexDegree), 'cellsOnVertex_full is not the right shape!'
    else:
