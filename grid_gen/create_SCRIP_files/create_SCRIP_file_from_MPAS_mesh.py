...
for iCell in range(nCells):
  ...
  if vertexMax < maxVertices:
    ...
    grid_corner_lat_local[iCell, vertexMax+1:] = latVertex[verticesOnCell[iCell, vertexMax-1] - 1]
    grid_corner_lon_local[iCell, vertexMax+1:] = lonVertex[verticesOnCell[iCell, vertexMax-1] - 1]
