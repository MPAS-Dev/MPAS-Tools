...
* a built-in barycentric interpolation method
...
parser.add_option("-c", "--input", dest="inputFile", help="name of input.  Can be either CISM format or MPASLI format.", default="cism.nc", metavar="FILENAME")
