...
!
! Modified by Chris Massey, USACE-ARMY-MIL to use ADCIRC's SIZES, SZ
! parameter for the kdkind type for consistency within ADCIRC.
! Also converted to fixed format instead of free format (f90).
      ...
      !
      ! Optional arguments:  If 'idim2' is specified, then the tree
      !                      will only search the first 'idim2' components
      !                      of input_data, otherwise, idim2 is inferred
