...
def main():
    """
    This script identifies "horns" on a mesh (cells with two or fewer
    neighbors), and marks them for culling.  In some cores/configurations,
    these weakly connected cells can be dynamically inactive, and, therefore,
    undesirable to keep in a mesh.
    ...
    print(f'\n{nHorns} "horn" locations have been marked in the field '
          f'cullCell.')
